...
## 📚 Estudando
- Python, Paradigmas e Aplicações (Estruturado, funcional e POO)
- Metodologias Ágeis (RAD)
- Computação em Nuvem (AWS, Azure)
- Banco de Dados (SQL, NoSQL)
- Código Limpo
- Participando do BootCamp da DIO: Python AI Back-End Developer (3 meses)
